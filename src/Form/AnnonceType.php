...
class AnnonceType extends AbstractType
{
    ...
    /**
     * Permet d'avoir la configutation de base d'un champs
     *
     * @param string $label
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('rooms', IntegerType::class, $this->getConfiguration("Nombre de chambres", "Combien de chambres sont disponibles?"))
            ->add('price', MoneyType::class, $this->getConfiguration("Prix par nuit", "Indiquez le prix auquel vous louez pour une nuit"))  
