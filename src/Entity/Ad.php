...
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="Le titre doit faire plus de 10 caractères !", maxMessage= "Le titre ne peux pas faire plus de 255 caractères")
     */
    private $title;
     ...
     * 
     * 
     * @return void Tableau d'objet DateTime representant les jours d'occupations
     */
